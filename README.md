...
**Автор:** О. С. Петрыкина · **Руководитель:** С. Н. Шилов
...
| PDF | [документы/Презентация (2).pdf](документы/Презентация%20(2).pdf) |
...
Для отображения в README и на GitHub — копия ключевых кадров: [`документы/артефакты_последнего_прогона/`](документы/артефакты_последнего_прогона/)

### Сводка кадров (макет · сайт · diff)

| Макет (baseline) | Скриншот сайта | Карта diff |
|------------------|----------------|------------|
| ![baseline](документы/артефакты_последнего_прогона/baseline.png) | ![current](документы/артефакты_последнего_прогона/current_1780430726840.png) | ![diff](документы/артефакты_последнего_прогона/diff_current_1780430726840.png) |
...
|-------------------|-------------|-------------|
| ![exp0](документы/артефакты_последнего_прогона/exp_0.png) | ![act0](документы/артефакты_последнего_прогона/act_0.png) | ![d0](документы/артефакты_последнего_прогона/diff_0.png) |
| ![exp1](документы/артефакты_последнего_прогона/exp_1.png) | ![act1](документы/артефакты_последнего_прогона/act_1.png) | ![d1](документы/артефакты_последнего_прогона/diff_1.png) |
...
├── документы/                # Курсовая, презентация, видео, артефакты для README
